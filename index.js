...
app.get("/card", async (req, res) => {
  try {
    ...
    // XP necesario para subir de nivel (puedes ajustar fórmula)
    ...
    ctx.fillText(`Nivel: ${nivelInt}`, 40, 520);
    ...
    ctx.fillRect(40, 630, 5.2 * Math.min(100, energyInt), 25);

    // Barra de ánimo
    ctx.fillText("Ánimo", 40, 670);
    ctx.fillStyle = "#555";
    ctx.fillRect(40, 690, 520, 25);
    ctx.fillStyle = "#ffcc00";
    ctx.fillRect(40, 690, 520 * (animoInt / 3), 25);

    // Barra de XP
    ctx.fillText(`XP: ${xpInt} / ${xpToNext}`, 40, 730);
    ctx.fillStyle = "#555";
    ctx.fillRect(40, 750, 520, 25);
    ctx.fillStyle = "#00aaff";
    ctx.fillRect(40, 750, 520 * xpPercent, 25);
